...
1.  What does a streak length of 1 mean, i.e. how many hits and misses are in a 
    ...
    A length of 1 indicates one hit bakset followed by one missed basket. A streak of 0 is a miss that follows another miss.
...
2.  Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. 
    ...
    His typical streak length was 0 or 1 and his longest streak was 4. His most frequent streak was an occurance of a miss that followed another miss.
...
```{r calc-streak-independent, eval=TRUE}
...
-   Describe the distribution of streak lengths. What is the typical streak 
    ...
    The typical streak of the independent shooter is 0 followed by a streak of 1. The longest streak for the independent shooter was 12. the independent shooter had a similar number of 0 streaks but Kobe had a higher number of streaks of 1.
...
Overall I would expect the distribution to be relatively close to the original experiment. I would expect that the highest streak would be 3 to 5 and not the strong outlier of 12 in the above sample. I would expect relatively the same amount of streaks of 0 and maybe slightly more streaks of 1.
...
Kobe's distribution seemed about the same as the independent the shooter minus the outlier of 12 for the independent. The fact that the distributions are very similar, and Kobe's highes streak was equal to the independents second highes streak, and Kobe didn't produce a streak even approaching the outlier of 12 for the independent leads me to belive that the hot hand model does not fit Kobe's shooting patterns.
